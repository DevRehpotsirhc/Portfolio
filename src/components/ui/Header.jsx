                        ...
                        <div className="flex flex-col w-60 max-[300px]:pr-0 max-[300px]:w-[85dvw] mt-9 max-h-[70dvh] overflow-y-auto p-2 pt-0 gap-2">
                            ...
                            <div className="flex flex-wrap items-center gap-2 m-auto">
                                ...
                                <button
                                    type="button"
                                    title="LinkedIn"
                                    className="flex items-center justify-center size-9.5 rounded-lg p-1 bg-primary-400 cursor-pointer border border-b-4 border-primary-600 shadow-md hover:scale-105 hover:shadow-primary-500/70 dark:hover:shadow-primary-300 transition-all duration-300"
                                >
